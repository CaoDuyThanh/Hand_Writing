...
class RNNModel():
    def __init__(self,
        ...
        # Setting RNN architecture
        self.Net         = LSTMNet()
        self.Net.NetName = 'LSTM_Encoder'
        self.Net.LayerOpts['rnn_num_hidden']   = numHidden
        self.Net.LayerOpts['rnn_inputs_size']  = inputSize
        self.Net.LayerOpts['rnn_outputs_size'] = outputSize

        # Create LSTM layer
        self.Net.Layer['rnn_truncid'] = RNNLayer(self.Net)

        # Truncate model
        yVals, modelUpdates = theano.scan(self.Net.Layer['rnn_truncid'].Step,
        ...
        params = self.Net.Layer['rnn_truncid'].Params
    ...
    def SaveModel(self,
                  file):
        self.Net.Layer['rnn_truncid'].SaveModel(file)
    ...
    def LoadModel(self,
                  file):
        self.Net.Layer['rnn_truncid'].LoadModel(file)
